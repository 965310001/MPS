...
public class PayOrderBean {
    ...
    public static class NewdataBean {
        ...
        private boolean if_delete;
        private boolean ownmall;
        private List<ExtendOrderGoodsBeanX> extend_order_goods;
        private List<?> zengpin_list;
        ...
        public List<ExtendOrderGoodsBeanX> getExtend_order_goods() {
            return extend_order_goods;
        }

        public void setExtend_order_goods(List<ExtendOrderGoodsBeanX> extend_order_goods) {
            this.extend_order_goods = extend_order_goods;
        }
        ...
        public static class ExtendOrderGoodsBeanX {
